...
import { Card, CardBody, DataTable, EmptyState, Skeleton, type Column } from '@/common/ui';
...
export default function SpectatorHubPage() {
  ...
  const scheduleColumns: Column<SpectatorRace>[] = [
  ...
  return (
    <div className="space-y-8">
      ...
      {racesQuery.isLoading ? (
        ...
        <EmptyState title="No featured race" description="There are no upcoming races scheduled right now." />
      )}
      ...
      <div className="grid gap-6 lg:grid-cols-[2fr_1fr]">
        ...
        <div>
          ...
          {racesQuery.isLoading ? (
            ...
            <EmptyState title="Nothing live right now" description="Check back when a race is under way." />
          )}
        </div>
