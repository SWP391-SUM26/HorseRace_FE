...
export function RegistrationDetailModal({ registration, onClose }) {
        ...
        reviewable ? (
          rejecting ? (
            ...
            <>
              ...
              <Button loading={approve.isPending} onClick={onApprove}>
    ...
    >
      <div className="flex flex-col gap-5">
        <div className="flex flex-wrap items-center gap-2">
          <Badge tone={REGISTRATION_STATUS_TONE[registration.status]}>
            ...
            <div className="flex flex-col gap-3 p-3">
              <div>
                <p className="font-semibold text-ink">
                  {horse?.name ?? registration.horseName ?? "—"}
                </p>
                <p className="text-xs text-muted">
                  {horse?.horseCode ?? registration.horseCode ?? ""}
                </p>
              </div>
              {horse && (
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <Field
                    label="Born"
                    value={
                      horse.dateOfBirth ? formatDate(horse.dateOfBirth) : null
                    }
                  />
                  <Field
                    label="Weight"
        ...
        <div className="rounded-xl border border-border p-3">
          ...
          {tournamentQuery.isPending ? (
            ...
            <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
              ...
              <Field
                label="Dates"
                value={`${tournament.startDate ? formatDate(tournament.startDate) : "—"} → ${tournament.endDate ? formatDate(tournament.endDate) : "—"}`}
              />
