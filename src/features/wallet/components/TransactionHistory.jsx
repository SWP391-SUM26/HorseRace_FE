  ...
  const columns = [
    {
      key: "date",
      header: "Date",
      render: (t) => <span className="text-muted">{fmtTime(t.createdAt)}</span>,
    },
    {
      key: "category",
      header: "Type",
      render: (t) => humanizeCategory(String(t.txnCategory)),
    },
    {
      key: "amount",
      header: "Amount",
      ...
      render: (t) => {
        ...
        return (
          <span
            className={
              debit ? "font-medium text-danger" : "font-medium text-success"
            }
          >
            {debit ? "-" : "+"}
    ...
    },
    {
      ...
      header: "",
      render: (t) => (
        <Badge tone={t.entryType === "DEBIT" ? "danger" : "success"}>
          {t.entryType}
        </Badge>
      ),
    },
