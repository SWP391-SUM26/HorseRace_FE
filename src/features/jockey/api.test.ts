...
function ride(partial: Partial<JockeyRide>): JockeyRide {
  return {
    id: 'r',
    raceId: 'race',
    raceName: 'Race',
...
describe('buildTrophies', () => {
  it('keeps only races won, newest first, deduped by name+year', () => {
    const trophies = buildTrophies([
      ...
      ride({ raceName: 'Derby', date: '2024-05-01T00:00:00Z', finishPosition: 1 }), // dup
      ride({ raceName: 'Sprint', date: '2025-01-01T00:00:00Z', finishPosition: 3 }), // not a win
    ]);
