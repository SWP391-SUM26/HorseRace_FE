...
describe('mapInvitation', () => {
  it('maps an InvitationResponse to an Invitation VM', () => {
    const inv = mapInvitation({
      assignmentId: 'a1', status: 'INVITED', invitedAt: '2026-01-01T00:00:00Z',
      horseName: 'Sapphire Wind', horseCode: 'HRS0003', raceName: 'Belmont', scheduledStartAt: null,
      tournamentName: 'Dubai', jockeyName: 'Alex Mercer', jockeyAvatarUrl: null, entryNo: 3,
    });
