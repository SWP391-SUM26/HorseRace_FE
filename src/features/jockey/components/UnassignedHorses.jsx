...
function UnassignedHorses({ entries, selectedId, onSelect }) {
  return <Card>
    ...
    return <li key={entry.id}>
      ...
      className={cn(
        ...
        selected ? "border-brand-700 bg-brand-50 ring-2 ring-brand-500" : "border-border hover:bg-subtle"
      )}
    >
                  ...
                  {selected && <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-brand-700 text-white">
